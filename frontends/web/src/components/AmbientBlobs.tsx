...
const BACK_BLOBS = [
  { size: 900, color: 'rgba(10,132,255,.05)',   anim: 'blob-back-1 70s ease-in-out infinite' },
...
const FRONT_BLOBS = [
  { size: 500, color: 'rgba(10,132,255,.09)',    anim: 'blob-front-1 45s ease-in-out infinite' },
